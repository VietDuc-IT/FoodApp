...
public class TinyDB {
    ...
    public ArrayList<modelProduct> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<modelProduct> playerList =  new ArrayList<modelProduct>();

        for(String jObjString : objStrings){
            modelProduct player  = gson.fromJson(jObjString,  modelProduct.class);
    ...
    public void putListObject(String key, ArrayList<modelProduct> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(modelProduct player: playerList){
